...
bool init = true;
PDIRECT3DTEXTURE9 flagptr = nullptr;
void Snowflake::Snowflake::Render()
{
    ...
    if (init)
    {
        ...
        /*D3DXCreateTextureFromFileInMemory(g_data, flag, sizeof(flag), &flagptr);*/
        init = false;
    }

    ImGui::SetCursorPos(ImVec2(pos.x, pos.y));
    ImGui::Image((void*)flagptr, { 80,80 });
